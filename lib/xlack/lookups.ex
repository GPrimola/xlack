defmodule Xlack.Lookups do
  ...
  @doc ~S"""
  Turns a string like `"#CHANNEL_NAME"` into the ID that Xlack understands
  ...
  @doc ~S"""
  Turns a Xlack user ID (`"U…"`), direct message ID (`"D…"`), or bot ID (`"B…"`)
  ...
  @doc ~S"""
  Turns a Xlack channel ID (`"C…"`) into a string in the format "#CHANNEL_NAME".
  """
